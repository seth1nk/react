...
useEffect(() => {
  ...
  if (!hasAcceptedCookies) {
    const timer = setTimeout(() => setIsVisible(true), 2000); // 2 секунды
  ...
  const handleMoreOptions = () => {
    console.log('More Options clicked - implement custom settings here');
    // Можно добавить модальное окно с настройками cookie
  };
  ...
  return (
    <div className="card">
      <div className="content">
        ...
        <button className="more-options" type="button" onClick={handleMoreOptions}>
          More Options
        </button>
